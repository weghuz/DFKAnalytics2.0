const heroData = `{statGenes visualGenes darkSummoned darkSummonLevels nextSummonTime background summonedTime network assistingPrice saleAuction {id endedAt duration startedAt endingPrice winner {id name}} staminaFullAt stamina hp mp privateAuctionProfile { id } previousOwner { name id } pjStatus xp privateAuctionProfile {id} fishing mining gardening foraging firstName owner{name id} salePrice lastName rarity genderStrDeprecated gender id shiny summons maxSummons level xp strength dexterity agility vitality endurance intelligence wisdom luck strengthGrowthP strengthGrowthS dexterityGrowthP dexterityGrowthS agilityGrowthP agilityGrowthS vitalityGrowthP vitalityGrowthS enduranceGrowthP enduranceGrowthS intelligenceGrowthP intelligenceGrowthS wisdomGrowthP wisdomGrowthS luckGrowthP luckGrowthS summons summonsRemaining maxSummons generation}`
