          ...
          <Card sx={{ width: "100%" }}>
            <CardContent>
              ...
              <Typography variant="body2">
                Find likeminded individuals to talk to about anything DFK or
                otherwise. Also a great way to provide feedback.
              </Typography>
            </CardContent>
            <CardActions>
          ...
          <Card sx={{ width: "100%" }}>
            <CardContent>
              ...
              <Typography variant="body2">
                ...
                aren't available ingame yet like Perilous Journey
                stats and even a filters for hero names.
              </Typography>
            </CardContent>
            <CardActions>
