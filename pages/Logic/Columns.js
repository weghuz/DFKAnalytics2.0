  ...
  "Primary Stat Growth": [
    ...
    },
    {
      ...
      render: (d, mode) => {
        if (mode == "display") {
          if (d.statBoost2 == "LCK") {
            return `<span style="color:${sb2}">${(d.luckGrowthP * 100).toFixed(
              2
            )}%</span>`;
          } else {
  ...
  "Secondary Stat Growth": [
    ...
    },
    {
      ...
      render: (d, mode) => {
        if (mode == "display") {
          if (d.statBoost2 == "LCK") {
            return `<span style="color:${sb2}">${(d.luckGrowthS * 100).toFixed(
              2
            )}%</span>`;
          } else {
...
const formattedColumns = [
  ...
  { label: "Class R1", value: "Class R1" },
  { label: "Class Recessives", value: "Class Recessives" },
  { label: "Subclass", value: "Subclass" },
  { label: "Subclass R1", value: "Subclass R1" },
  { label: "Subclass Recessives", value: "Subclass Recessives" },
  { label: "Level", value: "Level" },
  { label: "XP", value: "XP" },
  { label: "XP Current", value: "XP Current" },
  { label: "XP Max", value: "XP Max" },
  { label: "Shiny", value: "Shiny" },
  { label: "Generation", value: "Generation" },
  { label: "Summons", value: "Summons" },
  { label: "GenSum", value: "GenSum" },
  { label: "Health", value: "Health" },
  { label: "Mana", value: "Mana" },
  { label: "Stat Boost 1(Green +2)", value: "Stat Boost 1(Green +2)" },
  { label: "Stat Boost 1 R1", value: "Stat Boost 1 R1" },
  { label: "Stat Boost 1 Recessives", value: "Stat Boost 1 Recessives" },
  { label: "Stat Boost 2(Blue Growth)", value: "Stat Boost 2(Blue Growth)" },
  { label: "Stat Boost 2 R1", value: "Stat Boost 2 R1" },
  { label: "Stat Boost 2 Recessives", value: "Stat Boost 2 Recessives" },
  { label: "Profession", value: "Profession" },
  { label: "Profession Recessives", value: "Profession Recessives" },
  { label: "Profession R1", value: "Profession R1" },
  { label: "PJ Survivor", value: "PJ Survivor" },
  {
    label: "Perilous Journey Survival Rate",
    value: "Perilous Journey Survival Rate",
  },
  {
    label: "Perilous Journey Average Crystals",
    value: "Perilous Journey Average Crystals",
  },
  {
    label: "Perilous Journey Death Rate",
    value: "Perilous Journey Death Rate",
  },
  {
    label: "Perilous Journey Average Jewels",
    value: "Perilous Journey Average Jewels",
  },
  {
    label: "Perilous Journey Survival Crystals",
    value: "Perilous Journey Survival Crystals",
  },
  {
    label: "Perilous Journey Survival Tickets",
    value: "Perilous Journey Survival Tickets",
  },
  {
    label: "Perilous Journey Death Jewels",
    value: "Perilous Journey Death Jewels",
  },
  {
    label: "Perilous Journey Death Runes",
    value: "Perilous Journey Death Runes",
  },
  {
    label: "Perilous Journey Death Stones",
    value: "Perilous Journey Death Stones",
  },
  {
    label: "Perilous Journey Death Tickets",
    value: "Perilous Journey Death Tickets",
  },
  { label: "Total Stats", value: "Total Stats" },
  { label: "Statgain", value: "Statgain" },
  { label: "Max Stamina", value: "Max Stamina" },
  { label: "Current Stamina", value: "Current Stamina" },
  { label: "Stamina", value: "Stamina" },
  { label: "Stamina Full In", value: "Stamina Full In" },
  { label: "Stamina Full At", value: "Stamina Full At" },
  { label: "Profession Stats", value: "Profession Stats" },
  { label: "Profession Skill*2 + Stat", value: "Profession Skill*2 + Stat" },
  { label: "Element", value: "Element" },
  { label: "Element Recessive", value: "Element Recessive" },
  { label: "Element R1", value: "Element R1" },
  { label: "Class Score", value: "Class Score" },
  { label: "Class Score/Jewel", value: "Class Score/Jewel" },
  { label: "Growth Score", value: "Growth Score" },
  { label: "Growth Score/Jewel", value: "Growth Score/Jewel" },
  { label: "Active1", value: "Active1" },
  { label: "Active1 Recessive", value: "Active1 Recessive" },
  { label: "Active1 R1", value: "Active1 R1" },
  { label: "Active2", value: "Active2" },
  { label: "Active2 R1", value: "Active2 R1" },
  { label: "Active2 Recessive", value: "Active2 Recessive" },
  { label: "Passive1", value: "Passive1" },
  { label: "Passive1 R1", value: "Passive1 R1" },
  { label: "Passive1 Recessive", value: "Passive1 Recessive" },
  { label: "Passive2", value: "Passive2" },
  { label: "Passive2 R1", value: "Passive2 R1" },
  { label: "Passive2 Recessive", value: "Passive2 Recessive" },
  { label: "Stats Unknown 1", value: "Stats Unknown 1" },
  { label: "Stats Unknown 1 R1", value: "Stats Unknown 1 R1" },
  { label: "Stats Unknown 1 Recessive", value: "Stats Unknown 1 Recessive" },
  { label: "Stats Unknown 2", value: "Stats Unknown 2" },
  { label: "Stats Unknown 2 R1", value: "Stats Unknown 2 R1" },
  { label: "Stats Unknown 2 Recessive", value: "Stats Unknown 2 Recessive" },
  { label: "Mining Profession Skill", value: "Mining Profession Skill" },
  { label: "Foraging Profession Skill", value: "Foraging Profession Skill" },
  { label: "Fishing Profession Skill", value: "Fishing Profession Skill" },
  { label: "Gardening Profession Skill", value: "Gardening Profession Skill" },
  { label: "Profession Skill", value: "Profession Skill" },
  { label: "Stats", value: "Stats" },
  { label: "Primary Stat Growth", value: "Primary Stat Growth" },
  { label: "Secondary Stat Growth", value: "Secondary Stat Growth" },
  { label: "Statgain Split", value: "Statgain Split" },
  { label: "Statgain Split Weights", value: "Statgain Split Weights" },
  {
    label: "Statgain Split Weights Remove Base",
    value: "Statgain Split Weights Remove Base",
  },
...
module.exports = formattedColumns;
